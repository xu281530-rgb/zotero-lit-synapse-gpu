...
const PREF_API_BASE = 'extensions.zotero.zotero-lit-synapse.embedding.apiBase';
const PREF_API_KEY = 'extensions.zotero.zotero-lit-synapse.embedding.apiKey';
const PREF_MODEL = 'extensions.zotero.zotero-lit-synapse.embedding.model';
const PREF_DIMENSIONS = 'extensions.zotero.zotero-lit-synapse.embedding.dimensions';
const PREF_DETECTED_DIMENSIONS = 'extensions.zotero.zotero-lit-synapse.embedding.detectedDimensions';
const PREF_TIMEOUT_SECONDS = 'extensions.zotero.zotero-lit-synapse.embedding.timeoutSeconds';
...
const PREF_RPM = 'extensions.zotero.zotero-lit-synapse.embedding.rpm';
const PREF_TPM = 'extensions.zotero.zotero-lit-synapse.embedding.tpm';
const PREF_COST_PER_1M = 'extensions.zotero.zotero-lit-synapse.embedding.costPer1M';
const PREF_USAGE_STATS = 'extensions.zotero.zotero-lit-synapse.embedding.usageStats';
// Learned per-endpoint batch capacity, keyed by provider|baseURL|model
const PREF_BATCH_CAPACITY = 'extensions.zotero.zotero-lit-synapse.embedding.batchCapacity';
...
export class EmbeddingService {
  ...
  private async callEmbeddingAPI(
    ...
    try {
      ...
      const allowInsecure = Zotero.Prefs.get('extensions.zotero.zotero-lit-synapse.embedding.allowInsecureHTTP', true) === true;
