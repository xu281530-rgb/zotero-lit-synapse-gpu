...
menuitem-label = Zotero LitSynapse: ヘルパーサンプル
menupopup-label = Zotero LitSynapse: メニューポップアップ
menuitem-submenulabel = Zotero LitSynapse
menuitem-filemenulabel = Zotero LitSynapse: ファイルメニュー項目
...
notice-mineru-fallback = 高精度 MinerU テキストの代わりに内蔵 PDF 抽出で索引を作成しました。MinerU を修正して索引を再構築してください
