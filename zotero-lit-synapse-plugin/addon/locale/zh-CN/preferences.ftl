...
pref-client-config-description = 为主流 AI 客户端生成 MCP 服务器配置文件，方便快速连接到 Zotero LitSynapse MCP 服务器。
...
first-install-title = 欢迎使用 Zotero LitSynapse
first-install-prompt = 感谢安装 Zotero LitSynapse！为了开始使用，您需要为您的 AI 客户端生成配置文件。是否现在打开设置页面来生成配置？
