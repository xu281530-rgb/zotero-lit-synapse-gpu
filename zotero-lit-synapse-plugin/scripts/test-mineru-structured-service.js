...
preferences.set("extensions.zotero.zotero-lit-synapse.mineru.language", "en");
assert.equal(
...
preferences.delete("extensions.zotero.zotero-lit-synapse.mineru.language");
...
preferences.set("extensions.zotero.zotero-lit-synapse.mineru.mode", "local");
preferences.set(
  "extensions.zotero.zotero-lit-synapse.mineru.baseURL",
...
preferences.delete("extensions.zotero.zotero-lit-synapse.mineru.mode");
preferences.delete("extensions.zotero.zotero-lit-synapse.mineru.baseURL");
await service.suppressAutomaticMarkdown(1, pdf2.key);
assert.equal(await service.isAutomaticMarkdownSuppressed(pdf2), true);
...
const legacyDir = path.join(tempDir, "zotero-lit-synapse", "mineru", "LEGACY1");
...
const damagedDir = path.join(tempDir, "zotero-lit-synapse", "mineru", "DAMAGED1");
...
const longDir = path.join(tempDir, "zotero-lit-synapse", "mineru", longPDF.key);
