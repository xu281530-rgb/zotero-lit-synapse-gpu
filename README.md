...
- Existing Doc2X or previously-parsed MinerU Markdown is always reused before falling back to Zotero's built-in PDF worker, so nothing is re-parsed unnecessarily.
